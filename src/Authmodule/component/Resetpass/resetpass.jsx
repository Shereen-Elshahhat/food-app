                                   ...
                                   <form  onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    {errors.email&&<div className="alert alert-danger">{errors.email.message}</div>}
                                     ...
                                     <div class="input-group mb-2">
                                         ...
                                         class="form-control" placeholder="OTP" aria-label="Username" aria-describedby="basic-addon1"/>
                                     </div>
                                    {errors.otp&&<div className="alert alert-danger">{errors.otp.message}</div>}
                                     ...
                                     <div class="input-group mb-2">
                                         ...
                                         })} class="form-control" placeholder="New Password" aria-label="Username" aria-describedby="basic-addon1"/>
                                     </div>
                                    {errors.password&&<div className="alert alert-danger">{errors.password.message}</div>}
                                     ...
                                     <div class="input-group mb-2">
                                         ...
                                         {...register('confirmpass',{
                                          ...
                                          class="form-control" placeholder="Consirm New Password" aria-label="Username" aria-describedby="basic-addon1"/>
                                     </div>
                                    {errors.confirmpass&&<div className="alert alert-danger">{errors.confirmpass.message}</div>}

                                    <button className="btn btn-success text-white w-100">Reset Password</button>
